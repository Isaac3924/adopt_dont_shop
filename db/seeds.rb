...
@nhoj = Petition.create!(name: 'Nhoj', street_address: '2 Sesame St', city: 'Renved',
...
@pet3 = Pet.create!(name: 'Roo', age: 5, breed: 'Greatest Dane', adoptable: true, shelter_id: @shelter.id)

@petition_pet = PetitionPet.create!(petition_id: @john.id, pet_id: @pet1.id)
@petition_pet = PetitionPet.create!(petition_id: @john.id, pet_id: @pet2.id)
@petition_pet = PetitionPet.create!(petition_id: @bill.id, pet_id: @pet3.id)
@petition_pet = PetitionPet.create!(petition_id: @nhoj.id, pet_id: @pet1.id)